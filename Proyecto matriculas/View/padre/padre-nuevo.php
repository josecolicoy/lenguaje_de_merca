...
<form id="frm-alumno" action="?c=alumno&a=Guardar" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      <label>Nombres</label>
      <input type="text" name="nombres" class="form-control" placeholder="Ingrese nombres alumno"  />
    </div>

    <div class="form-group">
        <label>Apellidos Paternos</label>
        <input type="text" name="a_paterno" class="form-control" placeholder="Ingrese Apellidos Paternos"  />
    </div>

    <div class="form-group">
        <label>Apellidos Maternos</label>
        <input type="text" name="a_materno" class="form-control" placeholder="Ingrese Apellidos Materno"  />
    </div>
    ...
    <div class="form-group">
        ...
        <input type="text" name="direccion" class="form-control" placeholder="Ingrese direccion especificando sector"  />
    </div>

    <div class="form-group">
        <label>Comuna</label>
        <input type="text" name="comuna" class="form-control" placeholder="Ingrese comuna"  />
    </div>
